...
export const searchHotels = async (
  ...
  if (searchParams.adultCount !== undefined)
    queryParams.append('adultCount', searchParams.adultCount.toString())
  if (searchParams.childCount !== undefined)
...
export const fetchHotelsCountriesSummary = async (
  limit: number,
): Promise<IHotelsCountriesSummary[]> => {
